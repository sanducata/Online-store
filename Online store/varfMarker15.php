		...
		<div id="continut">
			...
			<div id="produs">
				...
				<div id="detaliiProdus">
					<div id="titluProd">
						<h1>VARF MARKER 15</h1>
					</div>
					<?php
						include "conexiune.php";
						$sql1 = "SELECT Pret FROM produse WHERE `Nume` = 'VARF MARKER 15'";
						$rez1 = mysql_query($sql1);
						$sql2 = "SELECT * FROM produse WHERE `Nume` = 'VARF MARKER 15'";
