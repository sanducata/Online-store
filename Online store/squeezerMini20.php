...
<head>
	<meta charset="utf-8">
	<title>GROG SQUEEZER MINI 20</title>
		...
		<div id="continut">
			...
			<div id="produs">
				...
				<div id="detaliiProdus">
					<div id="titluProd">
						<h1>SQUEEZER MINI 20</h1>
						<p>Varf rotund 20mm</p>
					</div>
					<?php
						include "conexiune.php";
						$sql = "SELECT * FROM produse WHERE `Nume` = 'SQUEEZER MINI 20'";
						$rez = mysql_query($sql);
						$sql1 = "SELECT Pret FROM produse WHERE `Nume` = 'SQUEEZER MINI 20'";
